...
class CetakLaporan extends BaseController
{
    ...
    public function index()
    {
        ...
        $laporan = $this->approvalFlowModel->getLaporanByBawahanIds($staffIds, ['APPROVE_SPV', 'APPROVE_MGR', 'APPROVE_PT']);
    ...
    {
        $dompdf = new Dompdf();
        $html = '<h2>Rekap Laporan Audit - Managerial</h2><table border="1" cellpadding="5" cellspacing="0" width="100%">';
        ...
        $dompdf->render();
        $dompdf->stream("Rekap_Laporan_Audit_Mgr.pdf", array("Attachment" => false));
        exit;
    }
    ...
    private function generateExcel($laporan)
    {
        ...
        $filename = 'Rekap_Laporan_Audit_Mgr.xlsx';
