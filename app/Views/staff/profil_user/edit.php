...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card shadow border-0 rounded-4 overflow-hidden">
            <div class="card-header border-bottom-0 py-4 text-center position-relative" style="background: linear-gradient(135deg, #0052D4 0%, #4364F7 100%);">
            ...
            <div class="card-body p-4 pt-5 mt-4">
                <form action="<?= base_url('staff/profil/update') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow-sm"><i class="fas fa-save me-2"></i>Update Profil Saya</button>
                    </div>
                </form>
            </div>
        </div>
