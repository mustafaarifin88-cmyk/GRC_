...
<div class="row justify-content-center">
    <div class="col-md-10">
        <a href="<?= base_url('managerial/approval') ?>" class="btn btn-light rounded-pill shadow-sm mb-3 fw-bold"><i class="fas fa-arrow-left me-2"></i>Kembali ke Daftar Approval</a>
        
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <div class="card-header text-white py-3 border-bottom-0" style="background: linear-gradient(135deg, #870000, #190A05);">
                <h4 class="card-title text-white m-0"><i class="fas fa-file-alt me-2"></i>Review Detail Laporan (Managerial)</h4>
            </div>
            
            <div class="card-body p-4">
                <div class="alert alert-light border shadow-sm mb-4 d-flex align-items-center">
                    <div class="avatar avatar-lg me-3 border border-2 shadow-sm" style="border-color: #870000;"><img src="<?= base_url('uploads/profiles/default-profile.png') ?>"></div>
                    <div>
            ...
            <div class="card-footer bg-white p-4 border-top">
                <div class="alert alert-warning border-0 shadow-sm"><i class="fas fa-info-circle me-2"></i>Pastikan Anda telah mereview seluruh dokumen sebelum memberikan persetujuan untuk disahkan Pimpinan Tinggi.</div>
                ...
                <div class="d-flex gap-3 justify-content-end mt-3">
                    ...
                    <a href="<?= base_url('managerial/approval/approve/'.$type.'/'.$laporan['id']) ?>" class="btn btn-success btn-lg rounded-pill px-5 shadow-sm fw-bold" onclick="return confirm('Apakah Anda yakin ingin menyetujui laporan ini?')"><i class="fas fa-check-double me-2"></i>Setujui Laporan</a>
                </div>
            </div>
        </div>
    </div>
