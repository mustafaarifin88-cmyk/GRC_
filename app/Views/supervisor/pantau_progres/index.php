...
<style>
    ...
    .nav-tabs .nav-link.active { background: linear-gradient(135deg, #0f0c29, #24243e); color: white; border-radius: 10px 10px 0 0; }
    .main-tab { border-bottom: 2px solid #24243e; margin-bottom: 20px; }
    .main-tab .nav-link.active { background: #24243e; color: white; border-radius: 5px; }
...
<script>
    ...
    function cekAlasan(type, id) {
        $.ajax({
            url: "<?= base_url('supervisor/pantau-progres/detail-alasan/') ?>" + type + "/" + id,
