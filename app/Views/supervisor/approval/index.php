        ...
        <form action="" method="GET">
            <div class="row align-items-end">
                <div class="col-md-9 form-group mb-0">
                    ...
                    <select class="form-select border-primary shadow-sm" name="kepala_unit_id" required>
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary w-100 rounded-pill shadow-sm"><i class="fas fa-filter me-2"></i>Terapkan Filter</button>
                </div>
            </div>
        </form>
    </div>
                                ...
                                <table class="table table-hover table-striped dt-table">
                                    ...
                                    <tbody>
                                        <?php if(empty($laporan[$key])): ?>
                                            <tr><td colspan="5" class="text-center text-muted">Tidak ada laporan yang perlu di-approve dari Kepala Unit ini.</td></tr>
                                        <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url('supervisor/approval/export-pdf/'.$key.'/'.$row['id']) ?>" class="btn btn-sm btn-info text-white rounded-circle shadow-sm me-1" title="Cetak PDF"><i class="fas fa-file-pdf"></i></a>
                                                    <a href="<?= base_url('supervisor/approval/approve/'.$key.'/'.$row['id']) ?>" class="btn btn-sm btn-success rounded-circle shadow-sm me-1" title="Approve" onclick="return confirm('Yakin ingin menyetujui laporan ini?')"><i class="fas fa-check"></i></a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow-lg">
            <div class="modal-header bg-danger text-white rounded-top-4">
                <h5 class="modal-title text-white"><i class="fas fa-exclamation-triangle me-2"></i>Tolak Laporan (Supervisor)</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <form action="<?= base_url('supervisor/approval/reject') ?>" method="POST">
