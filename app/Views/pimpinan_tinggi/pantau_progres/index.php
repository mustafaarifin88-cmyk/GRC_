...
<style>
    ...
    .nav-tabs .nav-link.active { background: linear-gradient(135deg, #141E30, #243B55); color: white; border-radius: 10px 10px 0 0; }
    .main-tab { border-bottom: 2px solid #141E30; margin-bottom: 20px; }
    .main-tab .nav-link.active { background: #141E30; color: white; border-radius: 5px; }
    .main-tab .nav-link { border-radius: 5px; margin-right: 5px; }
</style>

<div class="card shadow border-0 rounded-4 p-4">
    <div class="alert alert-info border-0 shadow-sm mb-4" style="background-color: #eef2f9; color: #141E30;"><i class="fas fa-info-circle me-2"></i>Daftar di bawah ini menampilkan laporan yang <b>Anda buat sendiri</b> maupun seluruh riwayat laporan staff yang <b>telah Anda sahkan secara final (Approve PT)</b> atau Anda tolak.</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <small style="color: #243B55;"><i class="fas fa-user-edit me-1"></i> <?= esc($d['nama_pembuat'] ?? 'Saya') ?></small>
                                    </td>
...
<script>
    ...
    function cekAlasan(type, id) {
        $.ajax({
            url: "<?= base_url('pimpinan/pantau-progres/detail-alasan/') ?>" + type + "/" + id,
