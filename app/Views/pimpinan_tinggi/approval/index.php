        ...
        <form action="" method="GET">
            <div class="row align-items-end">
                ...
                <div class="col-md-4 form-group mb-0">
                    ...
                    <select class="form-select shadow-sm" style="border-color: #243B55;" name="kepala_unit_id" <?= empty($list_ku) ? 'disabled' : '' ?> onchange="this.form.submit()">
                    ...
                    foreach($labels as $key => $label): ?>
                        <div class="tab-pane fade <?= $first ? 'show active' : '' ?>" id="v-<?= $key ?>" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
                                <h5 class="fw-bold text-dark m-0">Menunggu Pengesahan Akhir: <?= $label ?></h5>
                                ...
                                <table class="table table-hover table-striped dt-table">
                                    ...
                                    <tbody>
                                        <?php if(empty($laporan[$key])): ?>
                                            <tr><td colspan="5" class="text-center text-muted py-4">Tidak ada laporan yang perlu disahkan.</td></tr>
                                        <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url('pimpinan/approval/detail/'.$key.'/'.$row['id']) ?>" class="btn btn-sm text-white rounded-pill shadow-sm px-3" style="background-color: #243B55;">
                                                        <i class="fas fa-eye me-1"></i> Review & Sahkan
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
