...
<div class="row justify-content-center">
    <div class="col-md-10">
        <a href="<?= base_url('pimpinan/approval') ?>" class="btn btn-light rounded-pill shadow-sm mb-3 fw-bold"><i class="fas fa-arrow-left me-2"></i>Kembali ke Daftar Approval</a>
        
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <div class="card-header text-white py-3 border-bottom-0" style="background: linear-gradient(135deg, #141E30, #243B55);">
                <h4 class="card-title text-white m-0"><i class="fas fa-file-alt me-2"></i>Review Pengesahan Laporan (Final)</h4>
            </div>
            
            <div class="card-body p-4">
                <div class="alert alert-light border shadow-sm mb-4 d-flex align-items-center">
                    <div class="avatar avatar-lg me-3 border border-2 shadow-sm" style="border-color: #141E30;"><img src="<?= base_url('uploads/profiles/default-profile.png') ?>"></div>
                    <div>
            ...
            <div class="card-footer bg-white p-4 border-top">
                <div class="alert alert-info border-0 shadow-sm"><i class="fas fa-info-circle me-2"></i>Laporan ini telah melewati seluruh tahapan validasi. Menekan tombol sahkan akan merubah status laporan menjadi Final.</div>
                ...
                <div class="d-flex gap-3 justify-content-end mt-3">
                    ...
                    <a href="<?= base_url('pimpinan/approval/approve/'.$type.'/'.$laporan['id']) ?>" class="btn btn-success btn-lg rounded-pill px-5 shadow-sm fw-bold" onclick="return confirm('Apakah Anda yakin ingin mengesahkan laporan ini secara Final?')"><i class="fas fa-stamp me-2"></i>Sahkan Laporan Final</a>
                </div>
            </div>
        </div>
    </div>
