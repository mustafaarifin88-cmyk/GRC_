...
<style>
    ...
    .nav-tabs .nav-link.active { background: linear-gradient(135deg, #4b6cb7, #182848); color: white; border-radius: 10px 10px 0 0; }
    .main-tab { border-bottom: 2px solid #182848; margin-bottom: 20px; }
    .main-tab .nav-link.active { background: #182848; color: white; border-radius: 5px; }
...
<script>
    ...
    function cekAlasan(type, id) {
        $.ajax({
            url: "<?= base_url('kepalaunit/pantau-progres/detail-alasan/') ?>" + type + "/" + id,
